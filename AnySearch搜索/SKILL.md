---
name: anysearch
description: Search the web in real time, run AnySearch vertical domain lookups, batch multiple searches, and extract full page content through the bundled CLI scripts. Use when current internet information, structured domain search, or webpage extraction is needed.
---
