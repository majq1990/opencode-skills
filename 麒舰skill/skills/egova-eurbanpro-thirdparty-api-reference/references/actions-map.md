...
## 读取建议
- 看到上报 / REPORT / 多媒体字段 / 查询工单：再读 `references/reporting-and-query.md`
- 看到处置反馈 / 办理经过查询 / 督办 / 催办 / 签收 / 告知 / 上传附件：再读 `references/process-actions.md`
- 看到通知 / 签收通知：再读 `references/notice-and-signing.md`
- 看到 token / 签名：再读 `references/auth-apis.md`；方案准备请转 `egova-eurbanpro-thirdparty-preparation-guide`
