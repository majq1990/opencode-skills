...
## 继续阅读
- 若要查接口规则：转 `egova-eurbanpro-thirdparty-api-reference` 的 `references/common-protocol.md`
- 若要查 REPORT 参数：转 `egova-eurbanpro-thirdparty-api-reference` 的 `references/reporting-and-query.md`
- 若要查 REPORT 完整参数：转 `egova-eurbanpro-thirdparty-api-reference` 的 `references/report-full-params.md`
- 若要做报文诊断：转 `egova-eurbanpro-thirdparty-troubleshooting` 的 `references/diagnostic-playbook.md`
