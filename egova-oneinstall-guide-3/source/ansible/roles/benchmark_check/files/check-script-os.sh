...
echo "=============================dividing line================================"
echo "密钥管理测试：禁止在系统中明文存储，应该加密保护并提供访问控制（如文件权限是否为600或400）"
echo "=============================dividing line================================"
find /  -iname ""*.pem""  -o -iname ""*.crt"" -o -iname ""*.key"" -o -iname ""*.cacert""|grep egova |xargs ls -l

echo "=============================dividing line================================"
echo "禁止认证凭据明文存储或打印"
echo "=============================dividing line================================"
find / -path "/egova/onekey_install" -prune -o \( -iname "*.xml" -o -iname "*.conf" -o -iname "*.cnf" -o -iname "*.properties" -o -iname "*.yml" -o -iname "*.cfg" \) -print | grep egova | xargs grep -E "pass|key|password"
